...
export type Rejection='INVALID_COMMAND'|'STALE_REVISION'|'COMMAND_ID_CONFLICT'|'INVALID_STATE'|'SAVE_FAILED'|'INSUFFICIENT_GOLD'|'BOARD_FULL'|'INVALID_MERGE'|'LOCKED'|'MAX_TIER';

...
export const unlocks=new UnlockService(Array.from({length:10},(_,i)=>({id:`slot_${i+5}`,condition:{kind:'stageAtLeast',value:i<5?3:6},popupKey:i<5?'second_row_unlocked':'third_row_unlocked',targetFeatureId:`board_slot_${i+5}`,tutorialStepId:null})));

...
TASK-0229 / EV-045 correction: the former production fixed deployment cap3
contradicted first1/1 and Account Level2 +1. The new limit1→2 applies only to
simultaneously active heroes. Five visible battle placement platforms, their art
and usability remain as before; merge/dock board slots and stage-based island
unlocks are separate. The earlier suggestion to visually lock future battle
positions is explicitly superseded by the owner's clarification.

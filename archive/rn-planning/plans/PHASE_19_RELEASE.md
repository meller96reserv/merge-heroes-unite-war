...
[TASK-0234](../tasks/TASKS_PHASE_19.md) — Release build provenance. Produce tested package-named release APK/AAB/project ZIP with monotonic build numbers, source/toolchain/schema/data versions and checksums; prepare the required GitLab release pipeline/repository metadata and secure separate signing handoff. Required predecessors: TASK-0028, TASK-0029, TASK-0177, TASK-0178, TASK-0179, TASK-0202, TASK-0203, TASK-0229, TASK-0232, TASK-0142.

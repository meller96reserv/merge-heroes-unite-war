...
- `app/src/ui/TutorialOverlay.tsx` — Minimal first-session guidance
...
[TASK-0141](../tasks/TASKS_PHASE_11.md) — Tutorial step reducer. Persist completion version and advance only on committed matching events; skip policy explicit. Required predecessors: TASK-0075, TASK-0093, TASK-0147.

### Step 11.15

[TASK-0142](../tasks/TASKS_PHASE_11.md) — Minimal first-session guidance. Nonblocking highlight and tooltip for five initial steps; real gameplay events, durable forward reconciliation and simple Skip. Required predecessors: TASK-0141, TASK-0063.
...
- [TASK-0142](../tasks/TASKS_PHASE_11.md) — Minimal first-session guidance
...
- TASK-0141: REQUIRED_NOW. Owner-requested minimal five-step guide only.
- TASK-0142: REQUIRED_NOW. Existing Battle UI; broader reference tutorial remains deferred.

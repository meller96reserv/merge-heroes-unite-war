...
| DEFERRED_POST_DELIVERY | Additional progression | TASK-0130, TASK-0131, TASK-0140, TASK-0151, TASK-0152, TASK-0153 |
| REQUIRED_NOW | Additional progression | Completed |
...
QA consolidation: 12 duplicate/exhaustive QA tasks are additionally deferred; their mandatory checks move to named active owners. [Current QA policy](../docs/qa/10_DELIVERY_QA_POLICY.md) governs lightweight presentation acceptance, batched milestones and retained final release safety. Current classifications: DEFERRED_POST_DELIVERY: 81, REQUIRED_NOW: 51, SUPPORTING_REQUIRED: 20.

...
export const dataVersion='cocos-stages-v2';
export const heroes=new HeroCatalog(heroDefinitions);
export const boardConfig:BoardConfig={slotCount:15,columns:5,initialUnlocked:5,slotUnlockIds:Array.from({length:15},(_,i)=>i<5?null:`slot_${i}`)};

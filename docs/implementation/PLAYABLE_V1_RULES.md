...
empty usable islands and100 gold. First player purchase/placement deploys the
first hero and starts combat. Preserve existing saves. This overrides any earlier
...
- Start with 100 gold and one tier-1 hero on the five-open-slot board. Purchases fill the lowest free slot and join the battle while the three-hero deployment cap has room. Tap a hero to deploy/withdraw; its board ownership remains.
